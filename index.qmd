...
quartz(file = here("figs", "bars.png"), type = "png", dpi = 300, width = 9, height = 5.5)
print(p)
dev.off()
```
...
quartz(file = here("figs", "bars_comp.png"), type = "png", dpi = 300, width = 9, height = 6)
print(p)
dev.off()
```
...
quartz(file = here("figs", "bars_comp_super.png"), type = "png", dpi = 300, width = 9, height = 5.5)
print(p)
dev.off()
```
...
quartz(file = here("figs", "heatmaps.png"), type = "png", dpi = 300, width = 13, height = 6)
print(p)
dev.off()
```
...
quartz(file = here("figs", "scatters.png"), type = "png", dpi = 300, width = 12.5, height = 6)
print(p)
dev.off()
```
...
comp_plot <- ((p_domains[[1]] | p_domains[[2]] | p_domains[[3]]  | p_domains[[4]]) /
              (p_domains[[5]] | p_domains[[6]] | (p_domains[[7]]) | plot_spacer() ) ) +
  plot_annotation(
...
quartz(file = here("figs", "choropleths.png"), type = "png", dpi = 300, width = 9, height = 7)
print(comp_plot)
dev.off()
```
...
p <- sampled_points |> 
  ...
  plot_annotation(
    title=plot_title,
    subtitle="Each dot ~ 10 people randomly allocated within LSOA",
    caption="Source: 2021 Census"
  ) 

quartz(file = here("figs", "dot_density.png"), type = "png", dpi = 300, width = 8, height = 8)
print(p)
dev.off() 
```
...
quartz(file = here("figs", "buildings.png"), type = "png", dpi = 300, width = 6.5, height = 7)
print(p)
dev.off() 
```
